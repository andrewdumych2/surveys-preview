import {
  ...
  useOnElementChange,
  useOnValueChange
} from "./chunk-H5GVHQ6P.js";
import "./chunk-MI55ZJ63.js";
import "./chunk-YMAWIBUG.js";
import {
  require_react
...
var __decorateElement = (array, flags, name, decorators, target, extra) => {
  ...
  var j2 = array.length + 1, key = __decoratorStrings[k + 5];
  var initializers = array[j2 - 1] = [], extraInitializers = array[j2] || (array[j2] = []);
...
var Sortable2 = class {
  constructor(_a, manager) {
    ...
    this.register = () => {
      n(() => {
        var _a2, _b2;
        (_a2 = this.manager) == null ? void 0 : _a2.registry.register(this.droppable);
        (_b2 = this.manager) == null ? void 0 : _b2.registry.register(this.draggable);
      });
    ...
    this.unregister = () => {
      n(() => {
        var _a2, _b2;
        (_a2 = this.manager) == null ? void 0 : _a2.registry.unregister(this.droppable);
        (_b2 = this.manager) == null ? void 0 : _b2.registry.unregister(this.draggable);
      });
    };
    this.destroy = () => {
      n(() => {
      ...
      __spreadProps(__spreadValues({}, input), {
        ...
        effects: () => [
          ...
          () => {
            ...
            const feedback = (_b2 = (_a2 = this.draggable.pluginConfig(Feedback)) == null ? void 0 : _a2.feedback) != null ? _b2 : "default";
    ...
    o(() => {
      ...
      manager.renderer.rendering.then(() => {
        ...
        for (const animation of element.getAnimations()) {
          if ("transitionProperty" in animation && (animation.transitionProperty === "transform" || animation.transitionProperty === "translate" || animation.transitionProperty === "scale")) {
            animation.cancel();
          }
        }
...
function useSortable(input) {
  ...
  const transition = __spreadValues3(__spreadValues3({}, defaultSortableTransition), input.transition);
  const sortable = useInstance((manager) => {
    return new Sortable2(
      __spreadProps3(__spreadValues3({}, input), {
        transition,
        register: false,
  ...
  return {
    ...
    handleRef: (0, import_react.useCallback)(
      (element2) => {
    ...
    sourceRef: (0, import_react.useCallback)(
      (element2) => {
        var _a, _b;
    ...
    targetRef: (0, import_react.useCallback)(
      (element2) => {
        var _a, _b;
...
//# sourceMappingURL=@dnd-kit_react_sortable.js.map
